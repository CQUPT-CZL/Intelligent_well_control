...
class CheckStandpipePressure:
    ...
    def train(self, block_id):
        save = SaveToCsv(r'E:\项目\Intelligent_well_control\reports\standpipe_pressure_1_report.csv')
...
if __name__ == '__main__':
    ...
    checkDealDensity = CheckStandpipePressure(pd.read_csv(path))
