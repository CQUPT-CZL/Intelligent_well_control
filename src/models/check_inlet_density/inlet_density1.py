...
class CheckOverflow01():
    ...
    def train(self):
        ...
        save = SaveToCsv('/home/czl/project/Intelligent_well_control/reports/inlet_density_1_report.csv')
        # save.save({})
        ...
        rem_col_list = ['id', 'well_id', 'time', 'overflow_flag',
                        ...
                        'standpipe_pressure', 'casing_pressure', 'inlet_density']

        feature_names = list(filter(lambda x: x not in rem_col_list, self.data.columns))
